 ...
 * @param <N>
 */
public class ARGOptimizer<N extends Number> implements LinearModelOptimizer<N>, GradientDescentOptimizer<N> {
    ...
    public ARGOptimizer(JavaNumberTypeSupport<N> typeSupport) {
