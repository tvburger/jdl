...
import net.tvburger.dlp.nn.activations.Linear;
import net.tvburger.dlp.nn.activations.ReLU;
...
//                derivativesHalf[i] = Math.max(-1.0f, Math.min(1.0f, derivativesHalf[i] * 2.0f * scale));
