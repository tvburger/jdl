...
public class ElasticNet<N extends Number> implements ExplicitRegularization<N>, HyperparameterConfigurable {
    ...
    public JavaNumberTypeSupport<N> getCurrentNumberType() {
        return lasso.getCurrentNumberType();
    }
    ...
    public N lossPenalty(N[] parameters) {
        ...
        return getCurrentNumberType().add(loss1, loss2);
    }
    ...
    public N gradientAdjustment(N parameter) {
        ...
        return getCurrentNumberType().add(grad1, grad2);
    }
    ...
    public void setHyperparameter(String name, Object value) {
        if (HP_LAMBDA_1.equals(name)) {
            setLambda1(getCurrentNumberType().cast(value));
        } else if (HP_LAMBDA_2.equals(name)) {
            setLambda2(getCurrentNumberType().cast(value));
        }
    }
}
