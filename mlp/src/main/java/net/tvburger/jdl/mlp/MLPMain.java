...
import net.tvburger.jdl.model.nn.initializers.RandomWeightInitializer;
import net.tvburger.jdl.model.nn.learning.GradientDescent;
...
public class MLPMain {
    ...
    public static void main(String[] args) {
        ...
        mlp.init(new RandomWeightInitializer());
